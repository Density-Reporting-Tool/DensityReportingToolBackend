...
namespace DensityReportingToolBackend.Models.DTOs
{
    ...
    public class CreateProctorRequest
    {
        ...
        [RegularExpression("^(Modified|Standard)$", ErrorMessage = "Proctor type must be Modified or Standard")]
    ...
    // NOTE: ProctorCreateDto and ProctorUpdateDto have been moved to Models/Lab/Proctor.cs
    // to follow the same pattern as Job model (DTOs co-located with entity)

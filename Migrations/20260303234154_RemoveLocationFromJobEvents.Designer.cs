...
namespace DensityReportingToolBackend.Migrations
{
    ...
    [Migration("20260303234154_RemoveLocationFromJobEvents")]
    partial class RemoveLocationFromJobEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DensityReportingToolBackend.Models.JobEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DensityReportingToolBackend.Models.Proctor", b =>
                {
                    ...
                    b.Property<double?>("OversizePercentage")
                        .HasColumnType("double precision");

                    b.Property<string>("ProctorID")
                        .HasColumnType("text");

                    b.Property<string>("ProctorTestNumber")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DensityReportingToolBackend.Models.JobEvent", b =>
                {
                    b.HasOne("DensityReportingToolBackend.Models.GeoPacificEmployee", "CreatedBy")
                        .WithMany()

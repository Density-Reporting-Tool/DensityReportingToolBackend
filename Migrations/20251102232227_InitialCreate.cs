        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeoPacificEmployees_PersonalInfos_PersonalInfoId",
                        column: x => x.PersonalInfoId,
                        principalTable: "PersonalInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    GeoPacificEmployeeId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobProjectManagers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobProjectManagers_GeoPacificEmployees_GeoPacificEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProctorTestNumber = table.Column<string>(type: "text", nullable: true),
                    LabTestId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    DateTested = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    OversizePercentage = table.Column<double>(type: "double precision", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeoPacificEmployees_PersonalInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobProjectManagers_GeoPacificEmployeeId",
